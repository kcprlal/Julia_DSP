...
function rozwiazanie(;
    b::Vector{Float64} = [3.123897691708271e-5, 0.0, -0.00012495590766833085, 0.0, 0.00018743386150249627, 0.0, -0.00012495590766833085, 0.0, 3.123897691708271e-5],
    ...
    return sqrt(sum(y.^2)/length(y)) # energy/power/rms
4.975588325718084
end
rozwiazanie()